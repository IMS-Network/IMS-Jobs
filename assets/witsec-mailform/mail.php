...
$to = "jobs@ims-network.net";														// To Address
$toAlt = "";												// Additional Recipients
$from = "jobs@ims-network.net";													// From Address
$fromName = "התקבל טופס עובד חדש";											// From Name
...
$template = "היי,<br><br>מערכת עובדים קיבלת תופס קורות חיים חדש<br><br>{formdata}<br><br>{date} :תאריך<br>{ip} :אייפי<br><br>---<br>יום טוב, מערכת";											// Mail Template
